const settings = [
  { key: 'AutoComplete', shortcut: 'Alt+C', status: 'enabled', type: 'Command' },
  { key: 'AutoCompleteSelected', shortcut: 'Alt+Shift+C', status: 'enabled', type: 'Command' },
]
...
async function setup() {
  ...
  addListener('AutoCompleteSelected')
}
